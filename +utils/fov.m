function [dim,mat] = fov(dims,mats,vs,fov)
...
% mat  - [4x4]   Output V2W matrix
    ...
    if fov > 0
        ...
        % TODO: it would be nice to use some sort of average of all input 
        % matrices, but I haven't found a good way of doing it yet.
        mat = mats(:,:,1);
    end
