function varargout = matcomp(varargin)
%__________________________________________________________________________
% Collection of tools for matrices and vector/tensor fields.
%
% FORMAT out = utils.matcomp('name', input)
%
% FORMAT      A = utils.matcomp('LoadDiag', A)
% FORMAT     ld = utils.matcomp('LogDet', A)
% FORMAT      s = utils.matcomp('logsumexp',b,dm)
% FORMAT     iA = utils.matcomp('Inv', A)
% FORMAT      c = utils.matcomp('Pointwise3', a, (b), (op))
% FORMAT      c = utils.matcomp('Pointwise', a, (b), (op), (sym))
% FORMAT [Q,ll] = utils.matcomp('softmax',Q,scl)
% FORMAT    ind = utils.matcomp('SymIndices', k)
% FORMAT    ind = utils.matcomp('SymIndices', k)
% FORMAT      M = utils.matcomp('threshold_eig',M)
%
% FORMAT help utils.matcomp>function
% Returns the help file of the selected function.
%__________________________________________________________________________
% Copyright (C) 2017 Wellcome Centre for Human Neuroimaging
    if nargin == 0
        help utils.matcomp
